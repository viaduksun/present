...
include $_SERVER['DOCUMENT_ROOT'] . "/configs/db.php";
    ...
    if(isset($_POST["add"])) {
        if(isset($_POST['newtitle']) 
           ...
           $sql = "INSERT INTO `categories` (`title`) VALUES ('" . $_POST['newtitle'] . "')";
			...
			<div class="row">
				<div class="col-md-12 text-center">
					<div class="con-text">
							...
							<p><a href="/admin/">Главная</a> | <a href="/admin/pages/category.php">Category</a> | Add Category</p>
					</div>
				</div>
			</div>
	</div>
                                    ...
                                    <div class="easy2">
                                        <table class="table table-hover table-striped">
                                            <div class="container-fluid">
                                                ...
                                                <form action = "/admin/options/category/add_categories.php" method = "POST">
                                                  
                                                    <label for="formGroupExampleInput">Title category</label><br>
                                                    <input type="text" name="newtitle" class="form-control" placeholder="Title">
                                                    <br>
                                                    <button class="btn btn-primary ce5 p-2" type="submit" name="add">Add Category</button>
